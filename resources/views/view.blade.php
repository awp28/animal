                                ...
                                <div class="product-card-listing">
                                    <div class="product-image-wrapper position-relative">
                                        <div class="ratio ratio-4x3">
                                            @if($feed->img)
                                            <img src="{{ asset('storage/'.$feed->img) }}" class="w-100 h-100 object-fit-cover" alt="{{$feed->title}}">
                                            @else
                                    ...
                                    <div class="listing-details bg-light p-3">
                                        ...
                                        <p class="mb-2 text-dark fw-semibold">{{$feed->title}}</p>
                                        <p class="mb-2 text-muted small">{{$feed->description}}</p>
